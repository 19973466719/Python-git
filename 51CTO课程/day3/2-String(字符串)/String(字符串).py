...
#  %d      %s           %f              %.3f         占位符 无意义 只是占位
# 整数   字符串      小数默认六位  小数点后三位
#                                   精确到小数点后3位，会四舍五入
...
# \'   \"
print('tom is a \'good\' man') #打印出 tom is a 'good' man
print("tom is a \"good\" man") #打印出 tom is a "good" man
#      tom is a 'good' man
